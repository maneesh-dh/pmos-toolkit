#!/usr/bin/env bats
# Integration smoke: /grill --non-interactive — zero AskUserQuestion events.
...
@test "/grill headless run emits zero AskUserQuestion events" {
  transcript=$(run_skill_headless grill "")

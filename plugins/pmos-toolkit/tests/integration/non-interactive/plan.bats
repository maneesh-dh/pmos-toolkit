#!/usr/bin/env bats
# Integration smoke: /plan --non-interactive — zero AskUserQuestion events.
...
@test "/plan headless run emits zero AskUserQuestion events" {
  transcript=$(run_skill_headless plan "")

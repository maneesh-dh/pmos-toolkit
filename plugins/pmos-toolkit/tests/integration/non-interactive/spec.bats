#!/usr/bin/env bats
# Integration smoke: /spec --non-interactive — zero AskUserQuestion events.
...
@test "/spec headless run emits zero AskUserQuestion events" {
  transcript=$(run_skill_headless spec "")
